...
// CODE HERE
const evenNumbers  = mixedNumbers.filter((num, i) => num % 2 === 0)
...
// CODE HERE
  ...
  const bobPurchases = purchases.filter(purchase => purchase.owner === "Bob").reduce(function(acc,curr){return acc + curr.price},0);
