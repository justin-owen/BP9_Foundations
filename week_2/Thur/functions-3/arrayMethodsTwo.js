...
// CODE HERE
numbers.forEach((num,i)=>numbers[i]/=2)
console.log(numbers)
...
// CODE HERE
const citiesI = cities.filter(city => city[city.length - 1] === "i")
console.log(citiesI)
...
// CODE HERE
const fruitColor = fruits.forEach((element, i) => {
...
// CODE HERE
const riceTag = foods.filter((element) => (element.tags).includes("rice")).reduce(function (acc, cur) { return acc + cur.price }, 0)
console.log(riceTag)
