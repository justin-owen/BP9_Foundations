...
// CODE HERE
const printParameters = (par1, par2) => console.log(`The first parameter is ${par1}. The second parameter is ${par2}.`)
...
const pricesPlusTax = (prices, cb) => {
    for (let i = 0; i < prices.length; i++){
        ...
        let newCost = prices[i] + (prices[i] * .2)
...
const multiplyBy4= multiplyingFactory(4)
multiplyBy7(8)
multiplyBy4(8)
