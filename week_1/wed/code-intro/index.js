...
// CODE HERE
let speed = 25;
console.log(`Old network speed: ${speed}`)
...
// CODE HERE
speed = 500;
console.log(`New network speed: ${speed}`)
...
// CODE HERE
let faveSnack = "chips";
console.log(`Favorite snack: ${faveSnack}`)
...
// CODE HERE
let faveDrink = "Sweet Tea";
console.log(`Favorite drink: ${faveDrink}`)
...
// CODE HERE
const private = true;
console.log(`Private network: ${private}`)
...
// CODE HERE
let newTotal = netflix + hulu + peacock + disney + youtube;
...
console.log(`The total savings are ${savings}%.`)
